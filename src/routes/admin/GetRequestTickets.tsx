...
import { crudDialogButton } from "../../styles/CrudStyle";
import { DataTable, SearchFields } from "../../components/TableComponent";

export default function GetRequestTickets() {
  ...
  useEffect(() => {
    ...
    getTickets("request_agents").then((data: TicketType[]) => {
      setRows(
        filterSearch(
          data,
