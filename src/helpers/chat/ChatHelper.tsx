...
export async function deleteCellphone(id: number, idToken: number, setter: React.Dispatch<React.SetStateAction<number>>) {
    Swal.fire({
...
export async function createMessage(data: Record<string, any>, cellphone: number, setterMessage: React.Dispatch<React.SetStateAction<string>>) {
    try {
